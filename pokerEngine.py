...
from interface import TextInterface, GraphicsInterface, AIInterface
...
class PokerApp:
    ...
    def doRolls(self):
        ...
        toRoll = self.interface.chooseDice(self.gamestate())
...
def PokerAppSelector():
    ...
    """
    gamestyle = input('Player Poker Dice using [T]ext, [G]raphics, or [A]rtificial Intelligence? ')
